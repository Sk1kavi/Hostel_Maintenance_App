  ...
  return (
    ...
    >
      ...
      <Stack.Screen 
        ...
        options={{ title: 'My Complaints', headerLeft: null }}
      />
      <Stack.Screen 
        name="WardenDashboard" 
        component={WardenDashboardScreen} 
        options={{ title: 'Complaint Dashboard', headerLeft: null }}
      />
      <Stack.Screen 
        name="AdminDashboard" 
      ...
      <Stack.Screen 
        ...
        component={HostelManagementScreen} 
        options={{ title: 'Manage Hostels' }}
      />
      <Stack.Screen 
        name="UserManagement" 
