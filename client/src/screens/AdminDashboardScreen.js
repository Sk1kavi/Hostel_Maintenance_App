...
const AdminDashboardScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    applyFilters();
  }, [complaints, statusFilter, categoryFilter, hostelFilter]);
  ...
  const applyFilters = () => {
    ...
    if (hostelFilter !== 'All') {
      filtered = filtered.filter(complaint => complaint.hostel === hostelFilter);
    }
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptySubtitle}>
        {statusFilter !== 'All' || categoryFilter !== 'All' || hostelFilter !== 'All'
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.hostelInfo}>System Administrator</Text>
        </View>
      ...
      <View style={styles.managementContainer}>
        ...
        <View style={styles.managementButtons}>
          ...
          >
            <Icon name="domain" size={24} color="#2196F3" />
            <Text style={styles.managementButtonText}>Manage Hostels</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.managementButton}
